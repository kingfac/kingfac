...
<div class="relative grid w-full grid-cols-1 gap-6 px-10 md:grid-cols-3 -top-32 md:px-10 lg:px-20 animate__animated animate__bounceIn xl:px-60">
    <a class="py-10 text-center transition duration-300 transform bg-white rounded shadow hover:scale-105" href="{{route('pages', ['page'=>'dons', 'el'=>'null'])}}">
    ...
    <a class="py-10 text-center transition duration-300 transform bg-white rounded shadow hover:scale-105" href="{{route('pages', ['page'=>'faqs', 'el'=>'null'])}}">
        <i class="font-bold text-blue-900 text-7xl fa fa-user"></i>
    ...
    <a class="py-10 text-center transition duration-300 transform bg-white rounded shadow hover:scale-105" href="{{route('pages', ['page'=>'volontaire', 'el'=>'null'])}}">
        <i class="font-bold text-blue-900 text-7xl fa fa-user"></i>
